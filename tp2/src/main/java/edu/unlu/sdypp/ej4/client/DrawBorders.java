...
import static edu.unlu.sdypp.ej4.util.ImageUtils.imageIconToBufferedImage;

public class DrawBorders implements Tarea<ImageIcon>, Serializable {
    private static final long serialVersionUID = 6529685098267757690L;

    private ImageIcon image;

    public DrawBorders(ImageIcon image) {
        this.image = image;
    }
    ...
    public ImageIcon ejecutar() {
        System.out.printf("Sobel processing started for: %s \n", this.image);
        BufferedImage image = imageIconToBufferedImage(this.image);
        ...
        System.out.printf("Sobel processing finished for: %s \n", this.image.getDescription());
